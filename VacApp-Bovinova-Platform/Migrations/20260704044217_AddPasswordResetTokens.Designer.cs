...
namespace VacApp_Bovinova_Platform.Migrations
{
    ...
    [Migration("20260704044217_AddPasswordResetTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacApp_Bovinova_Platform.CampaignManagement.Domain.Model.Entities.CampaignStable", b =>
                {
                    ...
                    b.HasKey("CampaignId", "StableId")
                        .HasName("p-k_campaign-stables");

                    b.ToTable("campaign-stables");
                });

            modelBuilder.Entity("VacApp_Bovinova_Platform.IAM.Domain.Model.Aggregates.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("p-k_password-reset-tokens");

                    b.HasIndex("UserId")
                        .HasDatabaseName("i-x_password-reset-tokens_user_id");

                    b.ToTable("password-reset-tokens");
                });
            ...
            modelBuilder.Entity("VacApp_Bovinova_Platform.RanchManagement.Domain.Model.Aggregates.Product", b =>
                {
                    ...
                    b.Property<DateTime?>("ExpiryNotificationSentAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("expiry-notification-sent-at");
            ...
            modelBuilder.Entity("VacApp_Bovinova_Platform.RanchManagement.Domain.Model.Entities.BovineBreed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("p-k_bovine-breeds");

                    b.ToTable("bovine-breeds");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            MaxHeartRate = 80,
                            MaxTemperature = 39.299999999999997,
                            MinHeartRate = 40,
                            MinTemperature = 38.0,
                            Name = "Holstein"
                        },
                        new
                        {
                            Id = 2,
                            MaxHeartRate = 82,
                            MaxTemperature = 39.399999999999999,
                            MinHeartRate = 42,
                            MinTemperature = 38.0,
                            Name = "Jersey"
                        },
                        new
                        {
                            ...
                            MaxTemperature = 39.299999999999997,
                            MinHeartRate = 39,
                            MinTemperature = 37.899999999999999,
                            Name = "Brown Swiss"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 5,
                            MaxHeartRate = 78,
                            MaxTemperature = 39.200000000000003,
                            MinHeartRate = 38,
                            MinTemperature = 37.799999999999997,
                            Name = "Hereford"
                        },
                        new
                        {
                            Id = 6,
                            MaxHeartRate = 76,
                            MaxTemperature = 39.100000000000001,
                            MinHeartRate = 36,
                            MinTemperature = 37.5,
                            Name = "Charolais"
                        },
                        new
                        {
                            ...
                            MaxTemperature = 39.100000000000001,
                            MinHeartRate = 36,
                            MinTemperature = 37.600000000000001,
                            Name = "Limousin"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 10,
                            MaxHeartRate = 85,
                            MaxTemperature = 39.799999999999997,
                            MinHeartRate = 45,
                            MinTemperature = 38.5,
                            Name = "Brahman"
                        },
                        new
                        {
                            Id = 11,
                            MaxHeartRate = 84,
                            MaxTemperature = 39.700000000000003,
                            MinHeartRate = 44,
                            MinTemperature = 38.399999999999999,
                            Name = "Nelore"
                        },
                        new
                        {
                            Id = 12,
                            MaxHeartRate = 83,
                            MaxTemperature = 39.600000000000001,
                            MinHeartRate = 43,
                            MinTemperature = 38.299999999999997,
                            Name = "Gyr"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("VacApp_Bovinova_Platform.StaffAdministration.Domain.Model.Aggregates.Staff", b =>
                {
                    ...
                    b.HasIndex("UserId", "LinkedUserId")
                        .IsUnique()
                        .HasDatabaseName("i-x_staff_user_id_linked_user_id");
            ...
            modelBuilder.Entity("VacApp_Bovinova_Platform.CampaignManagement.Domain.Model.Entities.CampaignStable", b =>
                {
                    b.HasOne("VacApp_Bovinova_Platform.CampaignManagement.Domain.Model.Aggregates.Campaign", null)
                        .WithMany("CampaignStables")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("f-k_campaign-stables_campaigns_campaign_id");
                });
