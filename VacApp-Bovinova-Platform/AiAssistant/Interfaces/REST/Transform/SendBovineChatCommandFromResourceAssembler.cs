...
{
    public static SendBovineChatCommand ToCommandFromResource(BovineChatMessageResource resource, int userId)
    {
        return new SendBovineChatCommand(userId, resource.BovineId, resource.Message);
    }
}
